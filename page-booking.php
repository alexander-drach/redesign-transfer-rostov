      ...
      <div class="radio">
        ...
        <div class="radio-group">
          ...
          <label class="label" for="equipment1">
            <input class="radio-button" id="equipment1" type="checkbox" name="equipment" value="cradle">
            Люлька
          </label>

          <label class="label" for="equipment2">
            <input class="radio-button" id="equipment2" type="checkbox" name="equipment" value="armchair">
            Кресло
          </label>

          <label class="label" for="equipment3">
            <input class="radio-button" id="equipment3" type="checkbox" name="equipment" value="belt">
            Адаптер для ремня
          </label>

          <label class="label" for="equipment4">
            <input class="radio-button" id="equipment4" type="checkbox" name="equipment" value="No">
            Нет (12+)
          </label>
